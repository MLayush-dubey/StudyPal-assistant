...
from langchain.chains import ConversationalRetrievalChain  #this keeps previous interaction of the memory
...
load_dotenv()
DEVICE = os.getenv('DEVICE', 'cuda')  # Default to 'cuda' if not set
